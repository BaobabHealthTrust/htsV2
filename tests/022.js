module.exports = {
  '#22': function (client) {
    client
      ...
      .assert
      .visible('#barcode')
      .setValue('#barcode', 'XYZXYZ$')
      .waitForElementVisible('#ddeHelpText', 1000)
      .assert
      .containsText('.sectionHeader', 'Find Client By Name')
      .assert
      .visible('#ddeHelpText', 'Select or Create New Client')
      .assert
      .visible('#btnClear')
      .assert
      ...
      .assert
      .containsText('#u14HelpText', 'Create local with given ID?')
      .assert
      .visible('#Yes')
      .click('#Yes')
      .click('#btnNext')
      ...
      .waitForElementVisible('#touchscreenTextInput', 1000)
      .setValue('#touchscreenTextInput', '3')
      .click('#btnNext')
      .waitForElementVisible('#u14HelpText', 3000)
      .assert

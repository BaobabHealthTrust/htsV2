module.exports = {
  '#6': function (client) {
    client
      ...
      .waitForElementVisible('#lblResult', 3000)
      .assert
      .containsText('#lblResult', 'Immediate Parallel Repeat Test 1 & 2 Results')
      .assert
      .visible('#btnReactive1')
      .assert
      .visible('#btnReactive2')
      .assert
      .visible('#btnNonReactive1')
      .assert
      .visible('#btnNonReactive2')
      .click('#btnNonReactive1')
      .click('#btnNonReactive2')
      .click('#btnNext.green.nav-buttons')
      ...
      .waitForElementVisible('#touchscreenTextInput', 1000)
      .setValue('#touchscreenTextInput', '2')
      .click('#btnNext.green.nav-buttons')
      .waitForElementVisible('#u14HelpText', 3000)
      .assert
